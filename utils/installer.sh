install_prelude () {
    ...
    then
        ...
        cd $PRELUDE_INSTALL_DIR && /usr/bin/env git remote add upstream https://github.com/bbatsov/prelude.git
    else
...
#   Defaults to 'git@github.com:RZachLamberty/prelude.git'
# -i/--into
...
usage() {
    ...
    printf "  \t \t \t \t Defaults to 'git@github.com:RZachLamberty/prelude.git'.\n"
...
[ -z "$PRELUDE_URL" ] && PRELUDE_URL="git@github.com:RZachLamberty/prelude.git"
